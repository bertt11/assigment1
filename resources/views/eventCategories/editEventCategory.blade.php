...
<form action="{{ route('eventCategory.update', $eventCategory->id) }}" method="POST" class="container mt-4">
    @csrf
    @method('PUT')
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $eventCategory->name) }}" required style="width: 100%;">
        </div>
    </div>
